...
function editTask(index) {
    ...
    delButton.addEventListener("click", () => delTask(index));
    ...
    addButton.className = "text-white bg-yellow-400 hover:bg-yellow-600 font-medium rounded-lg text-sm px-5 py-2.5";
    addButton.onclick = () => saveTask(index);
